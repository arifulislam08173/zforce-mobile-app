...
//     useState<DropdownCustomer | null>(null);
...
//   const total = useMemo(() => {
//     return cart.reduce(
//       (sum, c) => sum + Number(c.product?.price ?? 0) * c.qty,
//       0,
//     );
//   }, [cart]);
...
//   // optional local search (frontend-only)
...
//       prev
//         .map((x) =>
//           String(x.product.id) === String(productId) ? { ...x, qty } : x,
//         )
//         .filter((x) => x.qty > 0),
//     );
//   }
...
//           price: Number(c.product.price || 0), // REQUIRED by backend
//         })),
//       };
...
//         }}
//       >
//         <Text style={{ fontWeight: "800", marginBottom: 8 }}>Customer</Text>
...
//             }}
//           >
//             <Text style={{ fontWeight: "800" }}>{selectedCustomer.name}</Text>
...
//         }}
//       >
//         <Text style={{ fontWeight: "800", marginBottom: 8 }}>Products</Text>
...
//             >
//               <Text style={{ fontWeight: "700" }}>{item.name}</Text>
//               <Text style={{ opacity: 0.7 }}>SKU: {item.sku ?? "-"}</Text>
//               <Text style={{ opacity: 0.7 }}>Price: {item.price ?? "-"}</Text>
//               <Text style={{ opacity: 0.7 }}>Stock: {item.stock ?? "-"}</Text>
//               <Text
...
//         }}
//       >
//         <Text style={{ fontWeight: "800", marginBottom: 8 }}>Cart</Text>
...
//             }}
//           >
//             <Text style={{ fontWeight: "700" }}>{c.product.name}</Text>
//             <Text style={{ opacity: 0.7 }}>Unit: {c.product.price ?? "-"}</Text>
...
//               <Text style={{ fontSize: 16, fontWeight: "800", paddingTop: 6 }}>
//                 {c.qty}
//               </Text>
